...
public class panel extends JPanel implements ActionListener {
    ...
    char dir='R';
    int score;
    boolean flag =false;//to keep check on the state of the game
    int xsnake[]=new int[288];//arrays to keep the coordinates of snake
    int ysnake[]=new int[288];
    panel(){
        this.setPreferredSize(new Dimension(width,height));
        this.setBackground(Color.BLACK);
        this.setFocusable(true);//to enable the keyboard input
        this.addKeyListener(new myKey());//adding keylistner,it tells me what is pressed
    ...
    public void gameover(Graphics graphic){
        ...
        graphic.setColor(Color.CYAN);//drawing the score
        //setting the font
        graphic.setFont(new Font("comic sans",Font.BOLD,40));
        FontMetrics fme=getFontMetrics(graphic.getFont());
        graphic.drawString("Score:"+score,(width-fme.stringWidth("Score:"+score))/2,graphic.getFont().getSize());
        ...
        graphic.setColor(Color.red);//drawing the gameover text
        //setting the font
        graphic.setFont(new Font("comic sans",Font.BOLD,80));
        FontMetrics fme1=getFontMetrics(graphic.getFont());
        graphic.drawString("GAMEOVER",(width-fme1.stringWidth("GAMEOVER"))/2,height/2);


        graphic.setColor(Color.green);//drawing the replay
        //setting the font
        graphic.setFont(new Font("comic sans",Font.BOLD,40));
